...
public class OperationsGetter extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            rs = (ResultSet) st.executeQuery("SELECT description, complete_operations.cost" +
                    ...
                    " AND complete_operations.id_order = "+ CompleteOrderGetter.arrayOrderComplete.get(CompleteOrders.temp2).getId()+"");
